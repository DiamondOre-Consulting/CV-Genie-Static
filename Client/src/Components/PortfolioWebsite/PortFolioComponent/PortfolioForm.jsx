    ...
    >
        Add Product
                            ...
                            <div className="p-6 border-t border-gray-200 rounded-b">
                                <button className="text-white bg-teal-900 focus:ring-4 w-full focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-3 text-center" type="submit"disabled={showLoader}>
                                    {showLoader ? (
