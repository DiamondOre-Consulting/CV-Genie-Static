...
const Testimonials = () => {
    return (
        <section className="bg-gray-50 text-gray-100">
                            ...
                            <div className="grid content-center gap-4">
                                <div className="p-6 rounded shadow-md bg-white ">
                                    ...
                                    <div className="flex items-center mt-4 space-x-4">
                                        <img src="https://cvgenie1.mydurable.com/_next/image?url=https%3A%2F%2Fcdn.durable.co%2Fmedia%2F15nsD269D5Plqv8uVoqq1398g5s7K8Ay35jPJrdunAfaIrgyIofsdWZGlXH9g0v4.png&w=1920&q=90" alt="" className="w-12 h-12 bg-center bg-cover rounded-full bg-gray-500" />
                                        <div>
                                            <p className="text-lg font-semibold text-gray-700">Leroy Jenkins</p>
                                        
                                        </div>
                                    </div>
                                </div>
                                <div className="p-6 rounded shadow-md bg-white">
                                    <p className='text-gray-500'>Thank you so much CV~Genie for up scaling my resume and making me understand why it is extremely important for having a proper resume today.
                                        Now getting more calls for interview than before.
                                        Thank you so much for your support.🙏</p>
                                    <div className="flex items-center mt-4 space-x-4">
                                        <img src="https://cvgenie1.mydurable.com/_next/image?url=https%3A%2F%2Fcdn.durable.co%2Fmedia%2F1d8FaT2Ji0GoR843ySQ2vyvXAPXLmlctiONsVSDgttaTM8ve5Yht6fCEQNivtGan.png&w=1920&q=90" alt="" className="w-12 h-12 bg-center bg-cover rounded-full bg-gray-500" />
                                        <div>
                                            <p className="text-lg font-semibold text-gray-700">Saurav Mukherji</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
