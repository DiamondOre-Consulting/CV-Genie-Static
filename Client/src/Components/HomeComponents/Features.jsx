  ...
  return (
    <>
      <section className='mt-24 px-10 ' id="feature">
        ...
        <div className="bg-white py-6 sm:py-8 lg:py-12 mt-4">
          <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
            <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
              <div className="flex gap-4 md:gap-6">
                <div className="flex h-12 w-12 shrink-0 hover:bg-black hover:text-white cursor-pointer border border-1 border-black items-center justify-center rounded-lg bg-white text-black  md:h-14 md:w-14 md:rounded-xl">
              ...
              <div className="flex gap-4 md:gap-6">
                <div className="flex h-12 w-12 shrink-0 border border-1 hover:bg-black cursor-pointer hover:text-white border-black items-center justify-center rounded-lg bg-white text-black  md:h-14 md:w-14 md:rounded-xl">
                <svg className="h-8 w-8 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="5" r="2" />  <circle cx="5" cy="19" r="2" />  <circle cx="19" cy="19" r="2" />  <circle cx="12" cy="14" r="3" />  <line x1="12" y1="7" x2="12" y2="11" />  <path d="M6.7 17.8l2.8 -2" />  <path d="M17.3 17.8l-2.8 -2" /></svg>
                </div>
              ...
              <div className="flex gap-4 md:gap-6">
                <div className="flex h-12 w-12 shrink-0 border border-1 border-black cursor-pointer hover:bg-black hover:text-white items-center justify-center rounded-lg bg-white text-black  md:h-14 md:w-14 md:rounded-xl">
                <svg className="h-8 w-8 "  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="12" cy="5" r="2" />  <circle cx="5" cy="19" r="2" />  <circle cx="19" cy="19" r="2" />  <circle cx="12" cy="14" r="3" />  <line x1="12" y1="7" x2="12" y2="11" />  <path d="M6.7 17.8l2.8 -2" />  <path d="M17.3 17.8l-2.8 -2" /></svg>
                </div>
