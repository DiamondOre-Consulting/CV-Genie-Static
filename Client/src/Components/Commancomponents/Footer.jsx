                ...
                <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
                    ...
                    <div className="flex flex-col justify-center pt-6 lg:pt-0">
                        <div className="flex justify-center space-x-4">
                            <a rel="noopener noreferrer" href="https://www.instagram.com/cv_genie_/?utm_source=qr&igsh=MXBuMm80MjUwNzViZg%3D%3D" target='_blank' title="Instagram" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-gray-400 text-gray-900">
                            ...
                            <a rel="noopener noreferrer" href="mailto:admin@cvgenie.in" title="Gmail" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-gray-400 text-gray-900">
